...
public class HanabiFireworksPanel extends JPanel {
    ...
    public void fireworkComplete(Point location, CardColor color) {
        ...
        List<Point> translator = Arrays.asList(new Point(-1, -1), new Point(-1, 1), new Point(1, -1), new Point(1, 1),
                new Point(0, 0));
    ...
    public void paintComponent(Graphics g) {
        ...
        if (paintSparks && !sparks.isEmpty()) {
            ...
            Spark[] array = sparks.toArray(new Spark[sparks.size()]);// todo:arrayindexoutofbounds???
